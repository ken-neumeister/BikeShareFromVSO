...
namespace Reporting.Models.TripCategories
{
    public class RowSubscriber : AbstractBikeRow, IEquatable<RowSubscriber>
    {
        ...
        public RowSubscriber(DataRow dr, Dictionary<string, int> colnbr) : base(dr, colnbr)
        {
    ...
    public class TableSubscriber : List<RowSubscriber> //: BikeTable
    {
        ...
        //{
        //    return new RowSubscriber(dr, colnbr);
        //}
    }
}